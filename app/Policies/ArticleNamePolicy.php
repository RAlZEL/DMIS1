...
class ArticleNamePolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\InventoryManagement\article\articlename  $articlename
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, articlename $articlename)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, articlename $articlename)
    {
        $Role = User::where('id','=',auth('web')->user()->id)->where('is_admin', true)->get()->first();
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, articlename $articlename)
    {
        $Role = User::where('id','=',auth('web')->user()->id)->where('is_admin', true)->get()->first();
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\FinancialManagement\article\articlename  $articlename
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, articlename $articlename)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, articlename $articlename)
    {
        //
    }
}