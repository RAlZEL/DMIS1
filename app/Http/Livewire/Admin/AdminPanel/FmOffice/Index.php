...
namespace App\Http\Livewire\Admin\AdminPanel\FmOffice;
...
class Index extends Component
{
    ...
    public function addOffice() {
        $this->authorize('create',  App\Models\Admin\AdminPanel\FinancialManagement\Office::class);
        $this->validate([
            'office' => 'required|unique:_office,office',
            'address' => 'required',
        ]);
    ...
    {
        $this->authorize('viewany',  App\Models\Admin\AdminPanel\FinancialManagement\Office::class);
        return view('livewire.admin.admin-panel.fm-office.index',[
            'Offices' => Office::orderby('id','asc')->search(trim($this->Search))
