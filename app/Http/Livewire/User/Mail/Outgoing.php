...
public function addRoute() {
    ...
    public function getOutgoingListsProperty() {
       ...
       return Document::orderby('updated_at','desc')->where('is_forwarded',true)->where('from_officeid', $Employee->officeid)->where('from_divisionid', $Employee->divisionid)->where('from_unitid', $Employee->unitid)->search(trim($this->Search))->paginate($this->perPage);
    ...
    public function render()
    {
        ...
        return view('livewire.user.mail.outgoing',[
