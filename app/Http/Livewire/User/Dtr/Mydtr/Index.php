...
namespace App\Http\Livewire\User\Dtr\Mydtr;
...
use App\Http\Livewire\Admin\EMS\Employees;
...
class Index extends Component
{
    ...
    public $isDTR;
    public $time1, $time2, $time3, $time4,$Late, $Undetime, $lateMortning , $lateAfternoon,$UndertimeMorning, $UndertimeAfternoon, $remarks;
    public $all_dtr;
    public $employeeName;
    public $print;
    ...
    public function searchDTR() {
       ...
       else 
       {
        ...
        $DTRLists = DTR::where('emp_id', $Employee->id)->whereBetween('date', [$this->startdate,$this->enddate])->get();
        ...
        if ($DTRLists) 
            {   
                ...
                while ($startDate->lte($endDate)){
                    ...
                    $Event = Event::where('office', $Employee->officeid)->where('date', $startDate)->get()->first();
                    ...
                    $this->Late = $this->Undetime =  $this->remarks =  null;
                        ...
                        elseif(Carbon::createFromDate($startDate)->format('D') == 'Sun')
                        {
                            ...
                            elseif($DTRLists)
                            {
                                ...
                                $totalut = null;
                                $totallate = null;
                                $DTRTime = DTR::where('emp_id', $Employee->id)->where('date', $startDate)->get();
    ...
    {
        return view('livewire.user.dtr.mydtr.index');
    }
}
