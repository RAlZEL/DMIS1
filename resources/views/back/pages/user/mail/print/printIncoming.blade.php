  ...
  <section class="invoice">
    ...
    <div class="row">
        <div class="col-12 text-center p-0 bx-solid"> 
               <div>
                  <h4><strong>DOCUMENT TRACKING</strong></h4>
      ...
      <div class="col-12 table-responsive">
        ...
        <table class="table table-stripped">
          ...
          <tr class ="">
            ...
            <th style="width: 200px;border-bottom: 1px solid black; border-top: 1px solid black;">PDN</th>
            <th style="width: 500px;border-bottom: 1px solid black; border-top: 1px solid black;"> Subject</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="border-bottom: 1px solid black;">{{ $List[2] . ' - ' . $List[3] . ' - ' . $List[4]}}</td>
