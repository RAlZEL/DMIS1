    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
      <div class="navbar navbar-light">
        <div class="container-xl">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('user.IM')}}">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" href="{{ route('user.IMCreateProperty')}}">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('user.IMReportOfficeArticle') }}">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" href="{{ route('user.inventoryPrint')}}">
