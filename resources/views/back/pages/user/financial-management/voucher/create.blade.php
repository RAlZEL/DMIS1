...
@section ('pageTitle',isset($pageTitle) ? $pageTitle : 'Financial Management System | New Voucher')
...
@section ('content')
     ...
     @livewire('user.financial-management.voucher.index')
...
<script>
    ...
    window.addEventListener('viewVoucher', function(e) {
        $('#view_voucher').modal('show');
    });
  

  $('#view_voucher').on('hidden.bs.modal', function(e) {  
