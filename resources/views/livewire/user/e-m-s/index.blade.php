<div>
    <div class="row row-cards"> 
        <div class="col-12">
            <div class="card">
                @can('create', App\Models\Admin\EMS\Employee::class)
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>  
                            <td class="text-center" data-label="Employee ID">{{ $Employee->employeeid }}</td>
                            <td class="text-center" data-label="First Name">{{ $Employee->firstname }}</td>
                            <td class="text-center" data-label="Middle Name">{{ $Employee->middlename }}</td>
                            <td class="text-center" data-label="Last Name">{{ $Employee->lastname }}</td>
                            <td class="text-center" data-label="Birth Date">{{ $Employee->birthdate }}</td>
                            <td class="text-center" data-label="Assigned Office">{{ $Employee->office->office }}</td>
                            <td class="text-center" data-label="Position">{{ $Employee->position }}</td>
                            <td class="text-center" data-label="Status">{{ $Employee->empstatus }}</td>
