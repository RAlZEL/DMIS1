            ...
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="position-relative">
                            <div class="input-group">
                                <input type="text" class="form-control" aria-label="Accountable Officer" wire:model.debounce.300ms="modalSearch" placeholder="Type officer name..." autocomplete="off">
                            ...
                            @endphp
                            @if($modalSearch && strlen($modalSearch) >= 2 && !$exactMatch)
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" id="dateToInput" class="form-control" wire:model.lazy="modalDateTo">
                    </div>
                                        <div class="col-md-3">
