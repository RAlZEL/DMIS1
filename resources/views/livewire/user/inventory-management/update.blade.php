    ...
    <form class="modal-content" method="POST" wire:submit.prevent="updateProperty">
      ...
      <div class="modal-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-lg-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" placeholder="Enter Unit" wire:model="edit_unit_of_measurement">
        ...
        <div class="row g-3">
          <div class="col-lg-6">
            <div class="mb-3">
              <label class="form-label">Quantity Per Property Card</label>
              <input type="text" inputmode="decimal" class="form-control" placeholder="Enter Quantity Per Card" wire:model="edit_quantity_per_card"
                style="-moz-appearance: textfield; -webkit-appearance: none;" 
                onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46">
              <span class="text-danger">@error('edit_quantity_per_card') {{ $message }} @enderror</span>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="mb-3">
