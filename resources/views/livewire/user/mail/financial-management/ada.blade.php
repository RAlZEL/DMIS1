<div>
    <div class="row row-cards"> 
        ...
        <div class="col-9">
            ...
            <div class="card">
                <div class="card-header">
                  {{-- <h3 class="card-title">Outgoing {{ Str::plural('Voucher', count($OutgoingLists)) }}</h3> --}}
                  <h3> ADA LIST</h3>
                </div>
                    ...
                    <table class="table card-table table-vcenter  datatable">
                        <thead>
                            <tr>
                              ...
                              <th class="w-1">ADA No. <!-- Download SVG icon from http://tabler-icons.io/i/chevron-up -->
                          ...
                          <tbody>
                            ...
                            <td> {{ $List->adano}}</td>
                            <td>
                            @foreach ($List->Voucher as $Voucher)
                            1
                                {{ $Voucher->sequenceid}}
                            @endforeach
                            </td>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted">No ADA List</td>
                            </tr>
