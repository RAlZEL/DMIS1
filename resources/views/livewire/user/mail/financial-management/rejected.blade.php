    ...
    <div class="row row-cards"> 
      <div class="col-sm-6 col-lg-4">
        ...
        <div class="col-sm-6 col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Rejected {{ Str::plural('Voucher', count($RejectedLists)) }}</h3>
                </div>
                    ...
                    <table class="table table-vcenter table-mobile-md card-table">
                        <thead>
                          ...
                          <tbody>
                            ...
                            <td>
                                <a href="user/financial-management-system/view/{{$List->id}}" tabindex="-1" target="_blank">{{ $List->particulars}}
                                </a>
                            </td>
