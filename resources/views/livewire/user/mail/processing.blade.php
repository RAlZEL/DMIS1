                ...
                <a href="{{ route('mail.userMail')}}" ss class="nav-link">
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail-exclamation mx-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <path d="M19 22v.01"></path>
                      ...
                      @if ($incomingCount != 0)
                      <span class="badge bg-red mx-2 text-xs">  {{ $incomingCount }} </span>
                      @endif
                    ...
                    <div class=" text-muted">
                      <button id="btnGroupDrop1" type="button" class="btn dropdown-toggle btn-sm" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-0.222214px, 38px, 0px);">
                          ...
                          @can('multipleTask', App\Models\Task\Task::class)
                          <a class="dropdown-item" wire:click.prevent="add_tasks">
                            Add Task
                          </a>
                          @endcan

                          @can('addMultipleClose', App\Models\DocumentTracking\Document::class)
                          <a class="dropdown-item" wire:click.prevent="markClose">
                            Mark as Closed {{ Str::plural('Document', count($selectedRows)) }}
                          </a>
                          @endcan
                ...
                <div class="table-responsive">
                  <table class="table table-vcenter table-mobile-md card-table">
                    ...
                    <tbody>
                        ...
                        <td class="text-muted"  data-label="Accepted By">{{ $List->fromuser->Employee->firstname}}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted">No Processing Document</td>
                        </tr>
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <datalist id="routeremarks">
                  ...
                  <input type="text" class="form-control" name="" list="routeremarks" placeholder="Enter Remarks" wire:model="remarks">
                  <span class="text-danger">
                      @error('remarks')
                      {{ $message }}
                      @enderror
...
<div wire:ignore.self class="modal modal-blur fade" id="close_documents" tabindex="-1" role="dialog" aria-hidden="true"
    data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <form class="modal-content" method="POST" wire:submit.prevent='markAllClose()'>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-body text-center py-4">
                ...
                <h3>Are you sure?</h3>
                <div class="text-muted">Do you want to close this Document(s).</div>
...
<div wire:ignore.self class="modal modal-blur fade" id="add_tasks" tabindex="-1" role="dialog" aria-hidden="true"
    data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form class="modal-content" method="POST" wire:submit.prevent='markAllask()'>
            <div class="modal-header">
