    ...
    <div class="row row-cards"> 
      <div class="col-sm-6 col-lg-4">
        ...
        <div class="col-sm-6 col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Outgoing Document(s)</h3>
                </div>
                <div class="card-body border-bottom py-3">
                  <div class="d-flex">
                    ...
                    @if ($OutgoingLists->count() !=0 && $selectedRows)
                    <div class=" text-muted">
                ...
                <div class="table-responsive">
                  <table class="table table-vcenter table-mobile-md card-table">
                    ...
                    <tbody>
                        ...
                        @forelse ($OutgoingLists as $List)
                        <tr>
                        <td data><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice" id="{{ $List->id }}" value="{{$List->id}}" wire:model="selectedRows"></td>
                        <td class="text-muted"  data-label="PDN">{{ $List->PDN }}</td>
                        <td class="text-muted text-nowrap"  data-label="Dcoument Type">{{ $List->doc_type}}</td>
                      ...
                      @endif
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted">No Outgoing Document</td>
                        </tr>
                ...
                <div class="card-footer d-flex align-items-center">
                  ...
                  {{ $OutgoingLists->links('livewire::bootstrap') }}
