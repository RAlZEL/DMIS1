                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $Voucher->sequenceid }}</td>
                            <td class="text-center">{{ $Voucher->FM_Office->office }}</td>
                            <td class="text-center">{{ $Voucher->particulars }}</td>

                            
                            <td class="text-center">{{ $Voucher->AccountName->acct_name . ' - ' . $Voucher->AccountNumber->acct_no }}</td>
                            <td class="text-center"><strong> {{ number_format($Voucher->amount,2,'.',',') }}</strong></td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="user/financial-management-system/view/{{$Voucher->id}}" class="btn btn-sm btn-primary" target="_blank">View</a> &nbsp;
                                </div>
                            </td>
                        </tr>
                        @empty
