        ...
        <div class="col-12">
            ...
            @can('createAllocation', App\Models\FinancialManagement\voucher::class)
                ...
                <div class="table-responsive">
                    ...
                    <thead>
                        <tr>
                            <th class="text-center">UACS Name</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" data-label="UACS Name">{{ $UACS->uacs }}</td>
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <a href="" class="btn btn-sm btn-danger" wire:click.prevent="deleteUACS({{$UACS->id}})">Delete</a>
                                    @endcan
                                </div>
                            </td>
                        </tr>
          ...
          <form class="modal-content" method="POST"
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="uacs" placeholder="Enter UACS Code and Description" wire:model="uacs">
                    <span class="text-danger"> @error('uacs')
                        {{ $message }}
